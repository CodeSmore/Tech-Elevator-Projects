...
namespace CompanyExercise
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             */
            Company ABC_Co = new Company("ABC Co");
            ABC_Co.NumberOfEmployees = 260;
            Console.WriteLine(ABC_Co.GetCompanySize());

            ABC_Co.Revenue = 50;
            Console.Write(ABC_Co.Revenue);

            ABC_Co.Expenses = 100;
            Console.WriteLine(ABC_Co.Expenses);

            Console.Write(ABC_Co.GetProfit());
