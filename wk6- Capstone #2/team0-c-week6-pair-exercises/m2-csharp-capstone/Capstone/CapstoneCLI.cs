    ...
    public class CapstoneCLI
    {
        ...
        public void SearchMenu()
        {
            ...
            else
            {
                ...
                ReservationMenu(arrivalDate, departureDate, siteList);
            }
        }

        public void ReservationMenu(DateTime arrivalDate, DateTime departureDate, List<Site> siteList)
        {
            // if invalid error then return
            bool invalidSite = true;
